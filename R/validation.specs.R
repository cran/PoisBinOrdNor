...
validation_specs <- function(no.pois,no.bin,no.ord,no.norm,corr.mat=NULL,prop.vec.bin=NULL,prop.vec.ord=NULL,lamvec=NULL,nor.mean=NULL,nor.var=NULL) {
  .Deprecated("validation.specs") #include a package argument, too
  validation.specs(no.pois,no.bin,no.ord,no.norm,corr.mat=NULL,prop.vec.bin=NULL,prop.vec.ord=NULL,lamvec=NULL,nor.mean=NULL,nor.var=NULL)
}

validation.specs<-function(no.pois,no.bin,no.ord,no.norm,corr.mat=NULL,prop.vec.bin=NULL,prop.vec.ord=NULL,lamvec=NULL,nor.mean=NULL,nor.var=NULL){
